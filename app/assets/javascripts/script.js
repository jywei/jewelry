...
(function ($) {
    $(window).on("load resize", function(){
        var o = $('.owl-carousel');
        if (o.length > 0) {
            var prev = $('.owl-controls .owl-prev');
            var next = $('.owl-controls .owl-next');
            var windowWidth = $(window).width();
            var containerWidth = $('.container').width();
            var widthExp = (windowWidth - containerWidth)/2;
            prev.css('left', -(widthExp - prev.width()/2));
            next.css('right', -(widthExp - next.width()/2));
        }
    });
})(jQuery);
...
(function ($) {
    ...
    $(document).ready(function () {
        $('.toggle-search').click(function (e) {
            ...
            $('.search.toggle-wrap').addClass('active');
        });
        ...
        $(document).on('click touchstart', function (e) {
            ...
            if (!container.is(e.target)
                ...
                $('.search.toggle-wrap').removeClass('active');
            }
        })
    });
})(jQuery);
